About alphalens-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/alphalens-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/quantopian/alphalens

Documentation: http://quantopian.github.io/alphalens/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2679&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/alphalens-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `alphalens` can be installed with `conda`:
...
It is possible to list all of the versions of `alphalens` available on your platform with `conda`:
...
```
mamba search alphalens --channel conda-forge
```
...
mamba repoquery search alphalens --channel conda-forge

# List packages depending on `alphalens`:
mamba repoquery whoneeds alphalens --channel conda-forge

# List dependencies of `alphalens`:
mamba repoquery depends alphalens --channel conda-forge
```
